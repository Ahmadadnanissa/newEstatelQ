...
class SecondPriceRaange extends StatefulWidget {
  final TextEditingController? minController;
  final TextEditingController? maxController;

  const SecondPriceRaange({super.key, this.minController, this.maxController});

  @override
  State<SecondPriceRaange> createState() => _SecondPriceRaangeState();
}

class _SecondPriceRaangeState extends State<SecondPriceRaange> {
